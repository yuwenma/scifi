...
func (c *spannerClient) ExecuteStreamingSql(ctx context.Context, in *ExecuteSqlRequest, opts ...grpc.CallOption) (Spanner_ExecuteStreamingSqlClient, error) {
	stream, err := c.cc.NewStream(ctx, &Spanner_ServiceDesc.Streams[0], "/google.spanner.v1.Spanner/ExecuteStreamingSql", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *spannerClient) StreamingRead(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Spanner_StreamingReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Spanner_ServiceDesc.Streams[1], "/google.spanner.v1.Spanner/StreamingRead", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *spannerClient) BatchWrite(ctx context.Context, in *BatchWriteRequest, opts ...grpc.CallOption) (Spanner_BatchWriteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Spanner_ServiceDesc.Streams[2], "/google.spanner.v1.Spanner/BatchWrite", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations must embed UnimplementedSpannerServer
...
// UnimplementedSpannerServer must be embedded to have forward compatible implementations.
...
func (UnimplementedSpannerServer) mustEmbedUnimplementedSpannerServer() {}
