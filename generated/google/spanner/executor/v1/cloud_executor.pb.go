...
type CreateCloudBackupAction struct {
	...
	VersionTime *timestamp.Timestamp `protobuf:"bytes,6,opt,name=version_time,json=versionTime,proto3,oneof" json:"version_time,omitempty"`
...
func (x *CreateCloudBackupAction) GetExpireTime() *timestamp.Timestamp {
	if x != nil {
		return x.ExpireTime
	}
	return nil
...
func (x *CreateCloudBackupAction) GetVersionTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *CopyCloudBackupAction) GetExpireTime() *timestamp.Timestamp {
	if x != nil {
		return x.ExpireTime
	}
	return nil
...
func (x *UpdateCloudBackupAction) GetExpireTime() *timestamp.Timestamp {
	if x != nil {
		return x.ExpireTime
	}
	return nil
...
func (x *StartBatchTransactionAction) GetBatchTxnTime() *timestamp.Timestamp {
...
type StartBatchTransactionAction_BatchTxnTime struct {
	...
	BatchTxnTime *timestamp.Timestamp `protobuf:"bytes,1,opt,name=batch_txn_time,json=batchTxnTime,proto3,oneof"`
}
...
func (x *ExecuteChangeStreamQuery) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *ExecuteChangeStreamQuery) GetEndTime() *timestamp.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
type SpannerActionOutcome struct {
	...
	CommitTime *timestamp.Timestamp `protobuf:"bytes,2,opt,name=commit_time,json=commitTime,proto3,oneof" json:"commit_time,omitempty"`
...
func (x *SpannerActionOutcome) GetCommitTime() *timestamp.Timestamp {
	if x != nil {
		return x.CommitTime
	}
	return nil
...
func (x *DataChangeRecord) GetCommitTime() *timestamp.Timestamp {
	if x != nil {
		return x.CommitTime
	}
	return nil
...
func (x *ChildPartitionsRecord) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
type HeartbeatRecord struct {
	...
	HeartbeatTime *timestamp.Timestamp `protobuf:"bytes,1,opt,name=heartbeat_time,json=heartbeatTime,proto3" json:"heartbeat_time,omitempty"`
}
...
func (x *HeartbeatRecord) GetHeartbeatTime() *timestamp.Timestamp {
	if x != nil {
